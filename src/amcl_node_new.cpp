        ...
        first_reconfigure_call_(true)
{
  ...
  pose_pub_ = nh_.advertise<geometry_msgs::PoseWithCovarianceStamped>("amcl_pose_new", 2, true);
  particlecloud_pub_ = nh_.advertise<geometry_msgs::PoseArray>("particlecloud_new", 2, true);
  global_loc_srv_ = nh_.advertiseService("global_localization_new",
  ...
  if(use_map_topic_) {
    map_sub_ = nh_.subscribe("map_maintained", 1, &AmclNode::mapReceived, this);
